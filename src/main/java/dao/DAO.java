...
//	Pet
	public List<Pet> getAllPet(){
		...
		try {
			...
			rs = ps.executeQuery();
			while(rs.next()) {
				list.add(new Pet(rs.getInt(1), rs.getString(2), rs.getInt(3), rs.getInt(4), rs.getInt(5)));
			}
		} catch (Exception e) {
	...
	public void insertPet(String name, String cat, String qty, String price) {
	...
	public Pet getPetById(String id) {
		...
		try {
			...
			rs = ps.executeQuery();
			while(rs.next()) {
				return (new Pet(rs.getInt(1), rs.getString(2), rs.getInt(3), rs.getInt(4), rs.getInt(5)));
			}
		} catch (Exception e) {
			// TODO: handle exception
		}
	...
	public void updatePet(String id, String name, String cat, String qty, String price) {
		String query = "update PetTbl set PName = ?, PCat = ?, Pqty = ?, Pprice = ? where PId=?";
		try {
			conn = new DBContext().getConnection();
			ps = conn.prepareStatement(query);
			ps.setString(1, name);
